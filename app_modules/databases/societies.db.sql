...
INSERT INTO "user" ("id","uuid","name","email","phone","last_logged_in") VALUES (1,'37683cce-e44b-4f55-b8d4-6de3d46f2d12','Master','master@email.com','1234567890','2022-02-21 10:47:25.607906'),
 (2,'350be8ce-447f-422e-8903-185f63fa1272','Admin','admin@email.com','12341515111','2022-02-23 16:56:05.118090'),
...
INSERT INTO "user_role" ("id","role") VALUES (1,'Master'),
 (2,'Admin'),
 (3,'User');
INSERT INTO "society" ("id","name","address","pin_code","country_currency_id") VALUES (1,'Esser Residency','Majhipara, Dashadrone',700136,76);
INSERT INTO "password_manager" ("id","password","user_id") VALUES (1,'sha256$HV3q1tBoq40y7L4h$3dab967e303cd55b0db894228ac32f899846ed615851f8ab29b0b93b67c7dcd8',1),
 (2,'sha256$QET0AbSqxU26t0A7$2f32dec205961650946f97833fce0bc3b8a0c08552bdf277caace983eb59d091',2),
 (3,'sha256$keNXKAeEbOuggP5D$7f0c4781752624faaec3e05d5cf3492a177762f0a2d0cd386410ad82fd03cf1d',3);
INSERT INTO "role_manager" ("id","user_id","society_id","role_id") VALUES (1,2,1,2);
INSERT INTO "flat" ("id","society_id","flat_code","area") VALUES (1,1,'1 A',994);
INSERT INTO "collection" ("id","name","society_id","type_id","rate","fixed","balance","collection_start_date") VALUES (1,'Monthly collection Feb 2022',1,1,2,0,0,'2022-02-12 00:00:00.000000');
INSERT INTO "member" ("id","user_id","flat_id") VALUES (1,2,1);
INSERT INTO "flat_owner" ("id","member_id") VALUES (1,1);
INSERT INTO "account" ("id","account_type_id","owner_id","due_amount") VALUES (1,2,NULL,0),
 ...
 (6,7,NULL,0),
 (7,1,1,1988);
INSERT INTO "transaction_log" ("id","public_id","sender_id","receiver_id","amount","date","method_id") VALUES (1,'72a83654',1,2,1988,'2022-02-22 02:38:29.679373',1);
INSERT INTO "income" ("id","owner_id","expected_amount","transaction_id","collection_id") VALUES (1,1,1988,NULL,1);
INSERT INTO "transaction_comment" ("id","comment","transaction_id") VALUES (1,'Due amount updated in all flat owners by system for collection ''Monthly collection Feb 2022''',1);
INSERT INTO "user_question_answer" ("id","user_id","question_id","answer") VALUES (1,2,1,'afasf'),
 (2,2,2,'asdfasf'),
 (3,2,3,'asdfasdf'),
 (4,2,4,'asdfasdf'),
 (5,2,5,'asdfasf');
